...
<body id="page-top">
	...
	<header class="masthead">
		<div class="container">
			<div class="masthead-subheading">🚫Please do not feed the animals🚫</div>
			<div class="masthead-subheading">Don`t forget to visit the panda enclosure🐼.</div>
			<div class="masthead-heading text-uppercase">🐼이 뚱 동 물 원🐨</div>
