	...
	<section class="page-section" id="gallery">
		<div class="container">
			<div class="text-center">
				<h1 class="mt-5">그저 고 dhd 쥐 사 항 인 걸</h1>
				<div class="card mb-4" style="min-height: 500px;">
					<div class="card-body">
						...
						<div class="row p-2 bg-secondary">
							...
							사육사 입니당 <a class="btn btn-secondary" href="./noticeDel ${detail.nno }">삭제</a>
							<button class="btn btn-secondary" onclick="location.href='./noticeUpdate?no=${detail.nno}'">수정</button>
							</div>
